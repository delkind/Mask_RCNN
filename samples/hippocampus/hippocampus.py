...
RESULTS_DIR = os.path.join(ROOT_DIR, "results/hippocampus/")
...
class HippocampusConfig(Config):
    ...
    STEPS_PER_EPOCH = 20 * (len(IMAGES) * (100 - VALIDATION_SPLIT) // 100) // IMAGES_PER_GPU
    VALIDATION_STEPS = max(1, len(IMAGES) * VALIDATION_SPLIT // 100 // IMAGES_PER_GPU)
